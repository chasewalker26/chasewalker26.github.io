...
title: About
permalink: /
subtitle: <a href='https://ufl.edu'>University of Florida</a>, <a href='chasewalker@ufl.edu'>chasewalker@ufl.edu</a>
...
profile:
  ...
  more_info: >
    <p>Email me for any questions or conversation!</p>

selected_papers: true # includes a list of papers marked as "selected={true}"
social: true # includes social icons at the bottom of the page

announcements:
  enabled: false # set true to include a list of news items
  scrollable: true # adds a vertical scroll bar if there are more than 3 news items
  limit: 5 # leave blank to include all the news in the `_news` folder

latest_posts:
  enabled: false # set true to include a list of blog posts
